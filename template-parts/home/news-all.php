<?php
/**
 * Template part for displaying all news posts on the front page
 *
 * @package QP3
 */
?>
...
<div class="list-posts swiper-container">
    ...
    <div class="swiper-wrapper blog-shortcode style-4">
        ...
        ?>
        <!-- Default news items if none are available -->
        <div class="swiper-item swiper-slide">
            <article id="post-72" class="post-item element hentry post-news post-72 post type-post status-publish format-standard has-post-thumbnail category-tin-phuong-dong category-tin-thi-truong">
                <div class="post-info" data-idpost="72">
